...
public class Score3CubeExp extends SequentialCommandGroup {
  /** Creates a new Score3Cube. */
  public Score3CubeExp(ArmSubsystem arm, DriveSubsystem drive, GripperSubsystem grip, WristSubsystem wrist) {
